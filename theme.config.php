...
$theme_config = array(
    ...
    // 기본환경설정의 최근게시물 등의 기본스킨 변경여부 true, false
    'preview_board_skin' => 'basic',
    // 테마 미리보기 때 적용될 기본 게시판 스킨
    'preview_mobile_board_skin' => 'basic',
    // 테마 미리보기 때 적용될 기본 모바일 게시판 스킨
    ...
    // 모바일 추천상품 출력 1줄당 이미지 수
    'de_mobile_type2_list_row' => 2,
    // 모바일 추천상품 출력 출력 줄 수
    'de_mobile_type2_img_width' => 300,
    // 모바일 추천상품 이미지 폭
    'de_mobile_type2_img_height' => 300,
    // 모바일 추천상품 이미지 높이
    ...
    // 모바일 분류 리스트 이미지 높이
    'ca_mobile_list_mod' => 2,
    // 모바일 분류 리스트 1줄당 이미지 수
    'ca_mobile_list_row' => 5,
    // 모바일 분류 리스트 이미지 줄 수
    'ev_skin' => 'list.10.skin.php',
    // 이벤트 출력 스킨
    'ev_img_width' => 225,
    // 이벤트 리스트 이미지 폭
    'ev_img_height' => 225,
    ...
    'ev_list_row' => 5,
    // 이벤트 리스트 이미지 줄 수
    'ev_mobile_skin' => 'list.10.skin.php',
    // 모바일 이벤트 출력 스킨
    'ev_mobile_img_width' => 230,
    // 모바일 이벤트 리스트 이미지 폭
    'ev_mobile_img_height' => 230,
    // 모바일 이벤트 리스트 이미지 높이
    'ev_mobile_list_mod' => 2,
    // 모바일 이벤트 1줄당 이미지 수
    'ev_mobile_list_row' => 5,
    // 모바일 이벤트 이미지 줄 수
    'ca_mobile_list_best_mod' => 2,
    // 모바일 상품리스트 베스트상품 1줄당 이미지 수
